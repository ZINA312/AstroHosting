  ...
  const popularPosts = [
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1532944706581-e4f394ab26c3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
      author: {
  ...
  return (
    <div className="home-page">
      <section className="featured-section">
        <h2 className="section-title">Featured Astrophotos</h2>
            ...
            {featuredPosts.map(post => (
              <div key={post.id} className="featured-slide">
                <div 
                  ...
                  onMouseEnter={() => setHoveredFeatured(post.id)}
                  onMouseLeave={() => setHoveredFeatured(null)}
                >
                  {hoveredFeatured === post.id && (
                    <motion.div 
